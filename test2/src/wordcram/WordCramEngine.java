...
public class WordCramEngine {
    ...
    void setWords(Word[] words) {
    	this.words = words;
    	this.eWords = wordsIntoEngineWords(words, new WordShaper(), new BBTreeBuilder());
    }
    ...
    void reset() {
    	eWordIndex = -1;
    	System.out.println("Reset " + eWordIndex + ", " + eWords.length);
    }
...
//        System.out.println("drawing to " + g2.hashCode());
